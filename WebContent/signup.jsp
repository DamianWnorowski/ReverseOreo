...
<script>
	function validateUsername() {
		var u = document.getElementById("username").value.toLowerCase();
		//alert("Checking username " + u);
		if (u === "") {
			...
			xhttp.onreadystatechange = function() {
				if (this.readyState == 4 && this.status == 200) {
					...
					if (this.responseText.replace(/\s/g, '') === ("invalid")) {
						alert("INVALID USERNAME!");
						return;
					} else {
...
<div class="container">
	...
	<form class="form-horizontal" name="searchform" method="post"
		...
		<div class="form-group col-sm-6">
			...
			<div class="col-sm-12">
				<label for="email">Email:</label> <input type="text"
					class="form-control" id="email" placeholder="xxx-xx-xxxx"
					name="email">
			</div>
		</div>
		<div class="form-group col-sm-6">
			...
			<div class="col-sm-12">
				<label for="phonenum">Phone Number:</label> <input type="text"
					class="form-control" id="phonenum" placeholder="(123) 456-7890"
					name="phonenum">
			</div>
		</div>
		...
		<div class="form-group col-sm-6">
			<div class="col-sm-12">
				<label for="address1">Address 1:</label> <input type="text"
					class="form-control" id="address1" placeholder="" name="address1">
			</div>
		</div>
		...
		<div class="form-group col-sm-6">
			<div class="col-sm-4">
				<label for="state">State:</label> <br></br> <select name="state">
		...
		<div class="col-sm-6">
			<label for="zipcode">Zip Code:</label> <input type="text"
				class="form-control" id="zipcode" placeholder="12345" name="zipcode">
		</div>
		<div class="form-group col-sm-12">
			<div class="col-sm-4">
				<button type="button" onclick="validateUsername()">Create</button>
