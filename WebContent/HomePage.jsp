	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<ul class="nav nav-pills" id="homepage-nav">
				<li class="active"><a data-toggle="pill" data-target ="#flight-search">Search
						Flights</a></li>
					...
					<div class="form-group col-sm-6">
						<div class="col-sm-12">
							<label for="origin">Origin:</label> <input type="text"
								class="form-control" id="origin" placeholder="City or Airport"
								name="origin">
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="col-sm-12">
							<label for="destination">Destination:</label> <input type="text"
								...
								placeholder="City or Airport" name="destination">
						</div>
					</div>
					<div class="form-group col-sm-6">
						<div class="col-sm-6">
