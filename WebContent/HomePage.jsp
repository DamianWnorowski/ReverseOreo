...
$(document).ready(function() {               
	    $('#flight-list').click(function(event) {
			var req;
			var t;
			t = document.getElementById("alias");
			var url ="http://localhost:8080/ReverseOreo/AllFlights";
...
<div class="panel panel-default">
	...
	<!-- Home Tabs -->
		<ul class="nav nav-pills">
		   <li class="active"><a data-toggle="pill" href="#flight-search">Search Flights</a></li>
		   <li><a data-toggle="pill" href="#flight-list">All Flights</a></li>
		   <li><a data-toggle="pill" href="#auctions">Auctions</a></li>
		 </ul>
	</div>
	...
	<div class="panel-body tab-content">
		...
		<div id="flight-list" class="tab-pane fade">
